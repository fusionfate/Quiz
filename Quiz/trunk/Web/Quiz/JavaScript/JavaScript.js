		...
		function AnimacaoBotaoInset(){
			...
			document.getElementById("Botao").style.border = 'inset 6px #45ce27';
		}

		function AnimacaoBotaoOutset(){
			document.getElementById("Botao").style.background = '#8d968a';
			document.getElementById("Botao").style.border = 'outset 6px #45ce27';
		}
		...
		function Enviar(){
			...
			document.getElementById("ProgressoTexto").style.color = '#45ce27';
